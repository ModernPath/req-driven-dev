...
|----|------|--------|-------------|
| INV-«CTX»-001 | «Rule description» | `USER:`/`DOC:` | «Where/how enforced» |
| INV-«CTX»-002 | «Rule description» | `USER:`/`DOC:` | «Where/how enforced» |
| INV-«CTX»-003 | «Rule description» | `USER:`/`DOC:` | «Where/how enforced» |
...
| ID | Question | Source / trigger | Owner | Blocking |
|----|----------|------------------|-------|----------|
| Q-«CTX»-1 | «Question» | `USER:`/`DOC:`/`CODE:` | «Owner» | «What it blocks» |
